...
import PrimmaryButton from './Shared/PrimaryButton'
  ...
  return (
    <>
     <div className='container py-14 relative'>
        <div className='relative z-20'>
            ...
            <div data-aos='fade-up' data-aos-delay='500' className='space-y-10'>
                <div data-aos='fade-up' data-aos-delay='500' className='grid grid-cols-1 sm:grid-cols-2 gap-4 py-10'>
                  <div>
                    <p>We know that <span className='text-primaryDark'>time</span>  is the greatest value in the modern world.Our healthy meal plan delivery service Good Food in Miami is the answer for those who want to eat healthily, saving time for buying food and preparing delicious, healthy meals.</p>
                  </div>
                <div></div>
                </div>
        ...
        <div data-aos='fade' className='absolute top-1/2 -translate-y-1/2 opacity-50 sm:opacity-100'>
